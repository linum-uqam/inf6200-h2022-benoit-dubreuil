# Demande de bourse de recherche de 1er cycle
...
Actuellement, pour sonder les entrecroisements des faisceaux de fibres blanches dans des cerveaux souris, nous employons un système d’histologie sérielle basée sur un microscope par tomographie en cohérence optique 3D (OCT). Bien que l’OCT est l’une des meilleures techniques de tractographie, entre autres grâce à sa forte sensibilité menant à un contraste plus net, sa précision est affaiblie par son rapport signal sur bruit détérioré selon la profondeur.
