...
\begin{document}
  ...
  coopératif, Honor) inscrit au cours d'initiation à la recherche (INF6200) sous la supervision du professeur Joël Lefebvre, nous avons exploré et étudié des outils
  scientifiques déjà existant dans le but de répondre à nos besoins.
  Ceux-ci sont la capacité d'automatisation potentielle, l'ergonomie et l'indépendance fonctionnelle.
  % TODO
