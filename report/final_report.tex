...
\begin{document}
  ...
  Pour ce faire, je tentais par tous les moyens possibles d'employer une [API](https://fr.wikipedia.org/wiki/Interface_de_programmation) publique du logiciel ciblé.
  Par exemple, j'ai d'abord essayé d'utiliser Fiberfox~\citep{neher2014fiberfox} programmatiquement, mais en vain.
  Alors, j'ai réussi à trouver et employer plusieurs adaptateurs sur GitHub me permettant grossièrement interfacer Fiberfox.
