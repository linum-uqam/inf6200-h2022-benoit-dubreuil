...
\begin{document}
  ...
  précises d'échantillons de cerveau (Lefebvre et al., 2021).
  ...
  Cette information est par la suite utilisée avec de nouveaux algorithmes de tractographie (Oliveira-Sicard et al., 2021).
  ...
  coopératif, Honor) inscrit au cours d'initiation à la recherche (INF6200) sous la supervision du professeur Joël Lefebvre, nous avons. % TODO
